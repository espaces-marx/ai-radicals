...
- Donner des techniques de création graphique assistée par IA ; pas seulement écrire un _prompt_ trivial et s'émerveiller du résultat, mais articuler l'IA avec d'autres techniques pour créer une affiche, un sticker, un visuel Instagram, etc.
